...
**Disposable analogies.** Analogies and comparisons that explain the point less clearly than the literal version. Common shape: "X is like Y" or "the same mechanism that..." followed by a familiar object (thermostat, engine, compass, scaffolding). If the analogy adds words but no new inference, cut it and state the mechanism directly.
